...
{
    // Input Feature Map
    ifstream ifs_conv_input("conv_input.bin", ios::in | ios::binary);
    ...
    // Weights
    ifstream ifs_conv_weights("conv_weights.bin", ios::in | ios::binary);
    ...
    // Bias
    ifstream ifs_conv_bias("conv_bias.bin", ios::in | ios::binary);
    ...
    // Golden Output
    ifstream ifs_golden_output("conv_output.bin", ios::in | ios::binary);
